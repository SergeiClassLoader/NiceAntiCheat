package pro.cyrent.anticheat.util.vec;
...
public class Vec3 {
    ...
    public double distanceSquared(Vec3 o) {
        return NumberConversions.square(this.xCoord - o.xCoord)
                + NumberConversions.square(this.yCoord - o.yCoord)
                + NumberConversions.square(this.zCoord - o.zCoord);
    }
    ...
    public Location toLocation(World world, float yaw, float pitch) {
        return new Location(world, this.xCoord, this.yCoord, this.zCoord, yaw, pitch);
    }
    ...
    public Vec3 normalize() {
        double d0 = sqrt_double(this.xCoord * this.xCoord + this.yCoord * this.yCoord + this.zCoord * this.zCoord);
    ...
    public double distanceTo(Vec3 vec) {
        ...
        return sqrt_double(d0 * d0 + d1 * d1 + d2 * d2);
    }

    public double distanceTo(Vector vec) {
        double d0 = vec.getX() - this.xCoord;
        double d1 = vec.getY() - this.yCoord;
        double d2 = vec.getZ() - this.zCoord;
        return sqrt_double(d0 * d0 + d1 * d1 + d2 * d2);
    }
    ...
    public double lengthVector() {
        return sqrt_double(this.xCoord * this.xCoord + this.yCoord * this.yCoord + this.zCoord * this.zCoord);
    }
